...
| `issues/2026-08-25-manifest-write-integrity.md` | 2026-08-25 | ◐ Partially resolved | **New 2026-08-25.** High. F-012 + F-021 + F-028: the unlocked manifest read-modify-write commits every filesystem mutation and drops the row that records it. Needs a shell harness to regression-test (`.tcyr` cannot fork). Tier 1. |
